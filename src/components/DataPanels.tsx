  ...
  return (
    <section className="py-20 px-4 relative z-10">
      <div className="container mx-auto">
        <h2 className="text-3xl font-cyber text-cyber-green text-center mb-12 glitch-text" data-text="DATA.CORE.ANALYSIS">
          DATA.CORE.ANALYSIS
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="cyber-panel p-6 col-span-1 lg:col-span-2">
            <h3 className="text-cyber-green font-mono text-lg mb-4">NEURAL.NETWORK.ACTIVITY</h3>
            <div className="h-48">
            ...
            <div className="mt-4 flex justify-between text-xs font-mono">
              <span className="text-cyber-blue">PACKETS.PROCESSED: 2,847,392</span>
              <span className="text-cyber-green">STATUS: OPTIMAL</span>
            </div>
          </Card>

          {/* System Monitor */}
          <Card className="cyber-panel p-6">
            <h3 className="text-cyber-green font-mono text-lg mb-4">SYSTEM.MONITOR</h3>
              ...
              {systemData.map((item) => (
                <div key={item.name} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-cyber-green text-xs font-mono w-8">{item.value}%</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Security Status */}
          <Card className="cyber-panel p-6">
            <h3 className="text-cyber-green font-mono text-lg mb-4">SECURITY.STATUS</h3>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-cyber-green text-sm">256-BIT</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          {/* Data Stream */}
          <Card className="cyber-panel p-6 col-span-1 lg:col-span-2">
            <h3 className="text-cyber-green font-mono text-lg mb-4">DATA.STREAM.ANALYSIS</h3>
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
